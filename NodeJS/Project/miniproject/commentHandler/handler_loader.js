...
function initHandlers(jayson, app, api_path) {
    ...
    var commentHandler = require('./viewComment');
    //*********** 종훈 추가끝 
    ...
    for (var i = 0; i < infoLen; i++) {
        ...
        // curHandler = commentEvent 객체

        /*
          commentEvent = { 
                          viewComment : function(params,callback){
                                              console.log~
                                        },
                          addComment : function(databsae,~){
        ...
        */
        ...
        // handlers['viewComment']와 같음
        /*
            handlers={
                'viewComment':{
                                handler: require('./viewComment),
                                collect: true,
                                params: Array
                             }
                 ...             
